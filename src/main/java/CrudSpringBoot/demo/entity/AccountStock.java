...
public class AccountStock {
    ...
    @ManyToOne
    @MapsId("accountId") // dentro de AccountStockId
    @JoinColumn(name = "account_id") // dentro de AccountStockId
    private Account account;

    @ManyToOne
    @MapsId("stockId") // dentro de AccountStockId
    @JoinColumn(name = "stock_id") // dentro de AccountStockId
    private Stock stock;
